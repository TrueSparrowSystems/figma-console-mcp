...
4. Review [Figma Component Reconstructor plugin documentation](https://github.com/TrueSparrowSystems/figma-sparrow-mcp)
5. [Open an issue](https://github.com/TrueSparrowSystems/figma-sparrow-mcp/issues) with example spec
