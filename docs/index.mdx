---
title: "Figma Sparrow MCP"
description: "Your design system as an API. Connect AI to Figma for extraction, creation, and debugging."
---

<Note>
**New in v1.11.0** — CDP fully removed, smarter multi-file tracking. Active file now follows your focused Figma tab when multiple projects have the Sparrow Bridge Plugin open. All error messages and status responses reference only the WebSocket Desktop Bridge.
</Note>
...
Figma Sparrow MCP bridges the gap between design and development—giving AI assistants complete access to your Figma files for extraction, creation, and debugging.
...
<Card title="Full Setup Guide" icon="book-open" href="/setup">
  Step-by-step instructions for connecting Figma Sparrow MCP to your AI client.
</Card>
